...
namespace Telefonkonyv
{
    ...
    public partial class cnTelefonkonyv : DbContext
    {
        ...
        private void SzemelyMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Szemely>().Property<short?>(@"HelységId").HasColumnName(@"HelységId").ValueGeneratedNever();
            modelBuilder.Entity<Szemely>().Property(x => x.HelysegId).HasColumnName(@"HelysegId").ValueGeneratedNever();
        ...
        private void HelysegMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Helyseg>().Property(x => x.HelysegId).HasColumnName(@"HelysegId").IsRequired().ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity<Helyseg>().HasKey(@"HelysegId");
        }
        ...
        {
            modelBuilder.Entity<Szemely>().HasOne(x => x.Helyseg).WithMany(op => op.Személyek).HasForeignKey(@"HelysegId").IsRequired(true);
            modelBuilder.Entity<Szemely>().HasMany(x => x.Számok).WithMany(op => op.Személyek);

            modelBuilder.Entity<Helyseg>().HasMany(x => x.Személyek).WithOne(op => op.Helyseg).HasForeignKey(@"HelysegId").IsRequired(true);
        }
